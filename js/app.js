...
function getNaturalizationCards() {
    return [
        ...
        { id: crypto.randomUUID(), question: "What is one right or freedom from the First Amendment?", answer: "Freedom of speech / Freedom of religion / Freedom of assembly / Freedom of the press / Right to petition the government" },
        ...
        { id: crypto.randomUUID(), question: "What are two rights in the Declaration of Independence?", answer: "Life / Liberty / Pursuit of happiness (pick any two)" },
        ...
        { id: crypto.randomUUID(), question: "Name one branch or part of the government.", answer: "Congress / Legislative / President / Executive / The courts / Judicial" },
        ...
        { id: crypto.randomUUID(), question: "What are two Cabinet-level positions?", answer: "Vice President / Secretary of State / Secretary of the Treasury / Secretary of Defense / Attorney General / Secretary of Agriculture / Secretary of Commerce / Secretary of Labor / Secretary of Health and Human Services / Secretary of Housing and Urban Development / Secretary of Transportation / Secretary of Energy / Secretary of Education / Secretary of Veterans Affairs / Secretary of Homeland Security (pick any two)" },
        ...
        { id: crypto.randomUUID(), question: "Under our Constitution, some powers belong to the federal government. What is one power of the federal government?", answer: "To print money / To declare war / To create an army / To make treaties" },
        { id: crypto.randomUUID(), question: "Under our Constitution, some powers belong to the states. What is one power of the states?", answer: "Provide schooling and education / Provide police / Provide safety (fire departments) / Give a driver's license / Approve zoning and land use" },
        ...
        { id: crypto.randomUUID(), question: "There are four amendments to the Constitution about who can vote. Describe one of them.", answer: "15th: any male citizen of any race can vote / 19th: any citizen (women) can vote / 24th: no poll tax required to vote / 26th: citizens 18 and older can vote" },
        { id: crypto.randomUUID(), question: "What is one responsibility that is only for United States citizens?", answer: "Serve on a jury / Vote in a federal election" },
        { id: crypto.randomUUID(), question: "Name one right only for United States citizens.", answer: "Vote in a federal election / Run for federal office" },
        { id: crypto.randomUUID(), question: "What are two rights of everyone living in the United States?", answer: "Freedom of expression / Freedom of speech / Freedom of assembly / Freedom to petition the government / Freedom of religion / Right to bear arms (pick any two)" },
        ...
        { id: crypto.randomUUID(), question: "What is one promise you make when you become a United States citizen?", answer: "Give up loyalty to other countries / Defend the Constitution and laws of the United States / Obey the laws of the United States / Serve in the U.S. military (if needed) / Serve the nation (if needed) / Be loyal to the United States" },
        { id: crypto.randomUUID(), question: "How old do citizens have to be to vote for President?", answer: "18 and older" },
        { id: crypto.randomUUID(), question: "What are two ways that Americans can participate in their democracy?", answer: "Vote / Join a political party / Help with a campaign / Join a civic group / Join a community group / Give an elected official your opinion / Call your Senator or Representative / Publicly support or oppose an issue / Run for office / Write to a newspaper (pick any two)" },
        ...
        { id: crypto.randomUUID(), question: "What is one reason colonists came to America?", answer: "Freedom / Political liberty / Religious freedom / Economic opportunity / Practice their religion / Escape persecution" },
        ...
        { id: crypto.randomUUID(), question: "There were 13 original states. Name three.", answer: "New Hampshire, Massachusetts, Rhode Island, Connecticut, New York, New Jersey, Pennsylvania, Delaware, Maryland, Virginia, North Carolina, South Carolina, Georgia (name any three)" },
        ...
        { id: crypto.randomUUID(), question: "The Federalist Papers supported the passage of the U.S. Constitution. Name one of the writers.", answer: "(James) Madison / (Alexander) Hamilton / (John) Jay / Publius" },
        { id: crypto.randomUUID(), question: "What is one thing Benjamin Franklin is famous for?", answer: "U.S. diplomat / Oldest member of the Constitutional Convention / First Postmaster General of the United States / Writer of \"Poor Richard's Almanac\" / Started the first free libraries" },
        ...
        { id: crypto.randomUUID(), question: "Name one war fought by the United States in the 1800s.", answer: "War of 1812 / Mexican-American War / Civil War / Spanish-American War" },
        { id: crypto.randomUUID(), question: "Name the U.S. war between the North and the South.", answer: "The Civil War" },
        { id: crypto.randomUUID(), question: "Name one problem that led to the Civil War.", answer: "Slavery / Economic reasons / States' rights" },
        { id: crypto.randomUUID(), question: "What was one important thing that Abraham Lincoln did?", answer: "Freed the slaves (Emancipation Proclamation) / Saved (or preserved) the Union / Led the United States during the Civil War" },
        ...
        { id: crypto.randomUUID(), question: "Name one war fought by the United States in the 1900s.", answer: "World War I / World War II / Korean War / Vietnam War / (Persian) Gulf War" },
        ...
        { id: crypto.randomUUID(), question: "Name one American Indian tribe in the United States.", answer: "Cherokee / Navajo / Sioux / Chippewa / Choctaw / Pueblo / Apache / Iroquois / Creek / Blackfeet / Seminole / Cheyenne / Arawak / Shawnee / Mohegan / Huron / Oneida / Lakota / Crow / Teton / Hopi / Inuit" },
        { id: crypto.randomUUID(), question: "Name one of the two longest rivers in the United States.", answer: "Missouri River / Mississippi River" },
        ...
        { id: crypto.randomUUID(), question: "Name one U.S. territory.", answer: "Puerto Rico / U.S. Virgin Islands / American Samoa / Northern Mariana Islands / Guam" },
        { id: crypto.randomUUID(), question: "Name one state that borders Canada.", answer: "Maine / New Hampshire / Vermont / New York / Pennsylvania / Ohio / Michigan / Minnesota / North Dakota / Montana / Idaho / Washington / Alaska" },
        { id: crypto.randomUUID(), question: "Name one state that borders Mexico.", answer: "California / Arizona / New Mexico / Texas" },
...
const NATURALIZATION_SEED_VERSION = 2;
const natSubject = appData.subjects.find(s => s.name.toLowerCase() === "naturalization test");
if (!natSubject) {
    appData.subjects.push({ id: crypto.randomUUID(), name: "Naturalization test", cards: getNaturalizationCards() });
    appData.naturalizationSeedVersion = NATURALIZATION_SEED_VERSION;
    localStorage.setItem("flashcardAppData", JSON.stringify(appData));
} else if (appData.naturalizationSeedVersion !== NATURALIZATION_SEED_VERSION) {
    natSubject.cards = getNaturalizationCards();
    appData.naturalizationSeedVersion = NATURALIZATION_SEED_VERSION;
    localStorage.setItem("flashcardAppData", JSON.stringify(appData));
}
